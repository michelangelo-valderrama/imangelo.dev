...
:::img-fig
![Figura 1: Esquema de algunas partículas fundamentales](@/assets/articles/esquema-particulas-fundamentales.png)
:::

:::img-fig
![Figura 2: Esquema indicando la masa, carga, grupo y extrañesa de las partículas fundamentales](@/assets/articles/esquema-masa-carga-grupo-extranesa-particulas-fundamentales.png)
:::

:::img-fig
![Figura 3: Imagen del espectro electromagnético, sus longitudes de onda, la escala aproximada de estas, su frecuencia, su temperatura y si penetran la atmósfera](@/assets/articles/espectro-electromagnetico.png)
:::

:::img-fig
![Figura 4: Imagen del proceso de fusión del hidrógeno](@/assets/articles/proceso-fusion-hidrogeno.png)
:::

:::img-fig
![Figura 5: Fotografía de la radiación del fondo cósmico de microondas](@/assets/articles/radiacion-del-fondo-cosmico-de-microondas.png)
:::
