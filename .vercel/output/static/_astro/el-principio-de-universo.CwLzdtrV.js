const e="el-principio-de-universo.mdx",a="articles",n="el-principio-de-universo",o=`
import Quote from '@/components/view/Quote.astro'
...
El universo se encuentra concentrado en una región de longitud $10^{-35}$ metros ($10^{25}$ veces más pequeño que un átomo) y a una temperatura de $10^{32}$ kelvin ($10^{29}$ veces la temperatura de nuestro Sol). Aquí está la frontera donde el concepto de _tiempo_ tiene sentido, un momento donde el universo está en perfecta simetría, la relatividad general y el _modelo estándar_ son incompatibles y las leyes físicas no se cumplen[^1]. Las cuatro fuerzas fundamentales —la **fuerza electromagnética**, la **fuerza nuclear fuerte**, la **fuerza
nuclear débil** y la **fuerza gravitatoria**— se encuentran unificadas, todas en una única **fuerza fundamental** o «fuerza madre», pero no por mucho.

## La Época de la Gran Unificación

La época de Planck ha terminado y se da una transición de fase[^2], esta comprende desde los $10^{-43}$ hasta los $10^{-36}$ primeros segundos del universo, que ahora se encuetra a una temperatura de $10^{27}$ kelvin.

En estos momentos el universo ha comenzado su proceso de expansión y se ha enfriado lo suficiente para permitir que la fuerza gravitatoria se separe de las otras fuerzas fundamentales —ahora formando una única fuerza llamada **fuerza electrofuerte**—, esto supone la primera de las rupturas de la simetría, que a su vez conllevará la aparición de las primeras partículas fundamentales (véase el [Apéndice](#apéndice)).

## La Época Inflacionaria

Entre los $10^{-36}$ y los $10^{-32}$ segundos, a una temperatura de $10^{22}$ kelvin, el universo se ha enfriado lo suficiente como para que la fuerza nuclear fuerte se separe de las otras dos —que ahora forman una única fuerza llamada **fuerza electrodébil**[^3]. Esta separación provocó una ruptura de la simetría que supuso una muy rápida e inmensa liberación de energía[^4]. Esta liberación de energía provocó la «inflación cósmica», proceso por el cual el universo se expandió de manera exponencial en un factor de $10^{26}$ en menos de una fracción de segundo. Se pasó de un universo más pequeño que un protón a uno del tamaño aproximado de una uva[^5]. Un universo donde todavía no existía la materia y donde solo habían fuerzas: bosones, gluones y, si existen, gravitones.

## La Época Electrodébil

Esta época se superpone ligeramente con la época inflacionaria pues comprende desde los primeros $10^{-36}$ hasta los $10^{-12}$ segundos desde el principio del universo, a una temperatura de $10^{15}$ kelvin, y es el principio del universo tal y como lo conocemos hoy día al ser la transición de fase asociada a la separación de todas la fuerzas fundamentales.

El universo se ha enfriado lo suficiente como para que la fuerza débil y la fuerza electromagnética se separen, provocando otra ruptura de la simetría, y formándose así los **bosones W y Z** —que suponen la primera aparición de masa en el universo— y los **fotones**, que no tienen masa[^6].
...
Entre los diez primeros segundos y los veinte primeros minutos, el plasma del universo desciende su temperatura hasta los $10^{7}$ kelvin, lo suficiente como para que se empiezen a formar los primeros «núcleos complejos».
...
:::img-fig
![Figura 1: Esquema de algunas partículas fundamentales](@/assets/articles/el-principio-del-universo/esquema-particulas-fundamentales.png)
:::

:::img-fig
![Figura 2: Esquema indicando la masa, carga, grupo y extrañesa de las partículas fundamentales](@/assets/articles/el-principio-del-universo/esquema-masa-carga-grupo-extranesa-particulas-fundamentales.png)
:::

:::img-fig
![Figura 3: Imagen del espectro electromagnético, sus longitudes de onda, la escala aproximada de estas, su frecuencia, su temperatura y si penetran la atmósfera](@/assets/articles/el-principio-del-universo/espectro-electromagnetico.png)
:::

:::img-fig
![Figura 4: Imagen del proceso de fusión del hidrógeno](@/assets/articles/el-principio-del-universo/proceso-fusion-hidrogeno.png)
:::

:::img-fig
![Figura 5: Fotografía de la radiación del fondo cósmico de microondas](@/assets/articles/el-principio-del-universo/radiacion-del-fondo-cosmico-de-microondas.png)
:::
...
`,s={title:"El Principio del Universo: Desde las partículas hasta las estrellas",description:"Un artículo sobre la cronología del Big Bang: Desde la época de Planck hasta la aparición de las primeras estrellas.",pubDate:new Date(16781472e5),category:"divulgación",tags:["cosmología"],isDraft:!1,cover:{src:"/images/el-principio-del-universo.webp",width:1734,height:1110,credits:"https://physics.oregonstate.edu/research/quantum-cosmology-and-foundations"}},r={type:"content",filePath:"/home/imangelo/Documents/01_Projects/imangelo.dev/src/content/articles/el-principio-de-universo.mdx",rawData:void 0};export{r as _internal,o as body,a as collection,s as data,e as id,n as slug};
